...
You'll need to authenticate your requests to access any of the endpoints in the Merlion API. In this guide, we'll look at how authentication works. {{ className: 'lead' }}
...
Merlion API using interceptor to inject access token.
